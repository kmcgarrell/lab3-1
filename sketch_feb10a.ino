  ...
  switch(ui_Robot_State_Index)
  {
    ...
    case 1:    //Robot Run after 3 seconds
    {
      if(bt_3_S_Time_Up)
      {
       ...
       //if((ui_Right_Line_Tracker_Data>(ui_Right_Line_Tracker_Light+ci_Line_Tracker_Tolerance))&&(ui_Left_Line_Tracker_Data>(ui_Left_Line_Tracker_Light+ci_Line_Tracker_Tolerance))&&(ui_Middle_Line_Tracker_Data > (ui_Middle_Line_Tracker_Light+ci_Line_Tracker_Tolerance)))
       //{
       ...
       while (millis()-timer1<500)
       {
        ...
        servo_LeftMotor.writeMicroseconds(ui_Left_Motor_Speed-500);
       ...
       int timer4 = millis();
       while(millis()-timer4<500)
       {
       servo_GripMotor.write(ci_Grip_Motor_Closed);
        
       }
   int timer5 = millis();
       while(millis()-timer5<500)
       {
        servo_ArmMotor.write(ci_Arm_Servo_Retracted);
       }
      ...
      int timer6 = millis();
        ...
        int timer7 = millis();
        while (millis()-timer7<500)
        {
         servo_LeftMotor.writeMicroseconds(ui_Left_Motor_Speed);
         servo_RightMotor.writeMicroseconds(ui_Right_Motor_Speed-250 );
        }
       while (true)
       {
